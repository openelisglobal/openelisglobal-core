...
<table width="100%" border="1">
      <tr>
          <td colspan="1" scope="col" width="9%" bgcolor="#CCCC99"><strong><bean:message key="resultsentry.history.tests.title"/></strong></td>
        ...
        <logic:notEmpty name="<%=formName%>" property="historyTestTestAnalytes">
         <logic:iterate id="hist_tst_ta" indexId="ctr" name="<%=formName%>" property="historyTestTestAnalytes" type="us.mn.state.health.lims.result.valueholder.Test_TestAnalyte">
          ...
          <bean:define id="totNumberOfRevisionsForTest" name="hist_tst_ta" property="totalNumberOfRevisionsToDisplayInHistoryForATest" type="java.lang.String"/>
          ...
          <bean:define id="testRevision" name="hist_analysis" property="revision" type="java.lang.String"/>
          ...
          <logic:notEmpty name="hist_tas">
           ...
           <bean:define id="hist_result" name="hist_tst_ta" property='<%= "results[" + hist_taCtr + "]"%>'/>
            ...
            <logic:equal name="hist_taCtr" value="0">
             <logic:equal name="totNumberOfRevisionsForTest" value='<%= String.valueOf(Integer.parseInt(testRevision) +1)%>'>
               <td rowspan="<%=hist_ct.intValue() * Integer.parseInt(totNumberOfRevisionsForTest)%>" scope="row" valign="top">
                 <strong><bean:write name="hist_test" property="testDisplayValue"/></strong>
               </td>
             </logic:equal>
            </logic:equal>
        	<logic:equal name="hist_taCtr" value="0">
