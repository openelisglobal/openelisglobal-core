...
function validateForm(form) {
	var validated = validateTestManagementNewbornForm(form);
...
function setFields(fieldName, value) {
    ...
    document.forms[0].accessionNumber.disabled=true;
}
...
function submitTheForm(form) {
	setAction(form, 'UpdateSampleDemographicsAnd','no','');
}

function checkYellowCardAndBarcode(field) {
    var barcode = $("barcode");
    var yellowCard = $("yellowCard");
    
    if ( barcode.value.charAt(0) == '9' )
        $("yellowCard").value = 'Y';
    else
    	$("yellowCard").value = 'N';
}
...
<table border="0">
    <tr>
        ...
        <td> 
		    <html:text name="<%=formName%>" property="accessionNumber" styleId="accessionNumber" styleClass="text" onblur="validateAccessionNumber(this);" size="20" maxlength="10" disabled="true"/>
        </td>        
        <td>
            <bean:message key="newborn.sample.full.barcode"/>:<span class="requiredlabel">*</span>
        </td>
        <td>
            <html:text name="<%=formName%>" property="barcode" styleId="barcode" styleClass="text" onblur="checkNumber(this);checkYellowCardAndBarcode(this);" size="20" maxlength="11"/>
    ...
    <tr>    
        ...
        <td>
            <html:text name="<%=formName%>" property="yellowCard" styleId="yellowCard" styleClass="text" onblur="formatField(this,true);checkYesNo(this);" size="1" maxlength="1"/>
            <div id="yellowCardMessage" class="blank">&nbsp;</div>
        </td>                 
    </tr>
...
<table border="0" width="100%">
    ...
    <tr>
       <td>
        ...
        <td colspan="3"><!--bugzilla 2619 styleClass defined 2x-->
...
<app:javascript formName="testManagementNewbornForm" staticJavascript="true"/>