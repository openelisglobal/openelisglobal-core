...
import us.mn.state.health.lims.reports.action.implementation.reportBeans.StudyVLColumnBuilder;
import us.mn.state.health.lims.reports.action.implementation.reportBeans.StudyEIDColumnBuilder;
...
public class ExportStudyProjectByDate extends CSVSampleExportReport implements IReportParameterSetter, IReportCreator {
	...
	protected String getReportNameForParameterPage() {
		return StringUtil.getMessageForKey("reports.label.project.export") + " "
				+ StringUtil.getContextualMessageForKey("sample.EnteredDate");
	}
