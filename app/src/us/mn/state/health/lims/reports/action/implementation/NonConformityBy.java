 ...
 * If you don't want any groupings, (1) use a simplier report format and (2) put "" (or null) for all group values. 
 * The reason this class is so generic is that it looked like there was going to be more than one table of counts.
 */
