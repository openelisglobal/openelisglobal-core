...
public class ARVInitialColumnBuilder extends ARVColumnBuilder {
	...
	protected void defineAllReportColumns() {
        ...
        add("nationality",      "NATIONAL", DICT_PLUS );    // nationality "other" is NOT stored in some other observation, but in the same observ, so we have to let actual strings pass through. 
