...
public class ARVFollowupColumnBuilder extends ARVColumnBuilder {
	...
	protected void defineAllReportColumns() {
        ...
        add("nationality",      "NATIONAL", BLANK );    // nationality "other" is NOT stored in some other observation, but in the same observ, so we have to let actual strings pass through. 
