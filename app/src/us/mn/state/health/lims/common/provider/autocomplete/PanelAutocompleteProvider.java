 ...
 */
public class PanelAutocompleteProvider extends BaseAutocompleteProvider {
	...
	public List processRequest(HttpServletRequest request,
		...
		//System.out.println("I am in AutocompleteParentPanelServlet "
		//		+ request.getParameter("parentPanelName"));
		String parentPanelName = request.getParameter("parentPanelName");
		//System.out.println("AutocompleteParentPanelServlet parentPanelName "
		//		+ parentPanelName);
		PanelDAO panelDAO = new PanelDAOImpl();
		List list = panelDAO.getActivePanels(parentPanelName);
		//System.out
		//		.println("AutocompleteParentPanelServlet list " + list.size());
