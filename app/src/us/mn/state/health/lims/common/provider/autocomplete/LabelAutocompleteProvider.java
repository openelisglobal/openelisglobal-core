 ...
 */
public class LabelAutocompleteProvider extends BaseAutocompleteProvider {
	...
	public List processRequest(HttpServletRequest request,
 		...
 		//System.out.println("I am in LabelAutocompleteProvider "
		//		+ request.getParameter("labelName"));
		String labelName = request.getParameter("labelName");
		System.out.println("LabelAutocompleteProvider labelName " + labelName);
		LabelDAO labelDAO = new LabelDAOImpl();
		List list = labelDAO.getLabels(labelName);
		//System.out.println("LabelAutocompleteProvider list " + list.size());
