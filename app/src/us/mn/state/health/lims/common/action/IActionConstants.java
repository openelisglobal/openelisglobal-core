...
public interface IActionConstants {
	...
	String QA_EVENTS_ENTRY_ROUTING_FROM_RESULTS_ENTRY_PARAM_ACCESSION_NUMBER = "accessionNumbersForUnsatisfactorySample";
	...
	String SELECTED_TEST_SECTION_ID = "selectedTestSectionId";

	
	String NO_LABEL_PRINTING = "NONE";

	
	String CURRENT_RECORD = "currentSampleRecord";
	String TOTAL_RECORDS = "totalSampleRecords";
	...
	String ACTION_REFINEMENT_SEPARATOR = ":";
    ...
    String ORG_SAMPLE_TYPE_REFERRER = "R";
}