 ...
 */
public class SampleTypeAutocompleteProvider extends BaseAutocompleteProvider {
	...
	public List processRequest(HttpServletRequest request,
		...
		String type = request.getParameter("typeOfSampleDesc");
		//bugzilla 1387
		String domain = request.getParameter("domain");
		TypeOfSampleDAO typeOfSampleDAO = new TypeOfSampleDAOImpl();
		List list = typeOfSampleDAO.getTypes(type, domain);
		//bugzilla 1387
		return list;
	}
