 ...
 */
public class SampleSourceAutocompleteProvider extends BaseAutocompleteProvider {
	...
	public List processRequest(HttpServletRequest request,
		...
		String source = request.getParameter("sourceOfSampleDesc");
		//bugzilla 1474
		String domain = request.getParameter("domain");
		SourceOfSampleDAO sourceOfSampleDAO = new SourceOfSampleDAOImpl();
		List list = sourceOfSampleDAO.getSources(source, domain);
