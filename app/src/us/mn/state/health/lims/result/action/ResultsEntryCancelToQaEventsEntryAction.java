 ...
 * bugzilla 2053 
 */
public class ResultsEntryCancelToQaEventsEntryAction extends BaseAction {
	...
	protected ActionForward performAction(ActionMapping mapping,
		...
		ResultsEntryRoutingSwitchSessionHandler.switchOff(RESULTS_ENTRY_ROUTING_FROM_QAEVENTS_ENTRY, session);
