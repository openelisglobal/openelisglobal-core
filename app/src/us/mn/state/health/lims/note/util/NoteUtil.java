...
public class NoteUtil {
	...
	private static final String NOTE_TYPE = "I";
	 ...
	 */
	public static Note createSavableNote(String noteId, String text, String objectId, String tableId, String noteSubject, String currentUserId) {
		Note note = null;
