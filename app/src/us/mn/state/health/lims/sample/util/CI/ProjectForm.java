...
/**
 * A type-safe enumeration of the known studies in CI, so that code doesn't have to hand around just another string. 
...
public enum ProjectForm {
    ...
    public Project getProject() {
        ...
        p = dao.getProjectByName(p, false, true);
        if (null == p) {
            throw new LIMSRuntimeException("Undefined Project name = " + projectName + ". Unable to find project for form.");
        }
        return p;
    }
    ...
    private static Map<String, ProjectForm>form2ProjectFormMap = new HashMap<String, ProjectForm>();
