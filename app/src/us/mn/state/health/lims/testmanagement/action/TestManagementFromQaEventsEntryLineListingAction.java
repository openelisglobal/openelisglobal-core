 ...
 * bugzilla 2504
 */
public class TestManagementFromQaEventsEntryLineListingAction extends BaseAction {	
	...
	protected ActionForward performAction(ActionMapping mapping,
		...
		TestManagementRoutingSwitchSessionHandler.switchOn(TEST_MANAGEMENT_ROUTING_FROM_QAEVENTS_ENTRY_LINELISTING, session);
