...
public enum OrganizationTypeList {
    ...
    EID_ORGS("shortName",                   SHORTNAME_NUMERIC_COMPARATOR, "EID ACONDA-VS CI", "EID EGPAF", "EID ESTHER", "EID ICAP", "SEV-CI", "ARIEL"),
    EID_ORGS_BY_NAME("organizationName",    ORGANIZATION_NAME_COMPARATOR, "EID ACONDA-VS CI", "EID EGPAF", "EID ESTHER", "EID ICAP", "SEV-CI", "ARIEL"),
