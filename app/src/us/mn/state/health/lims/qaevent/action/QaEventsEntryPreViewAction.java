 ...
 * 
 */
public class QaEventsEntryPreViewAction extends BaseAction {
	...
	protected ActionForward performAction(ActionMapping mapping,
		...
		try {
    		...
    		//bugzilla 2154
			LogEvent.logError("QaEventsEntryPreViewAction","performAction()",e.toString());
		...
		try {
    		...
    		//bugzilla 2154
			LogEvent.logError("QaEventsEntryPreViewAction","performAction()",lre.toString());
			errors = new ActionMessages();
        ...
        //bugzilla 2501
		if (!StringUtil.isNullorNill(multipleSampleMode) && !multipleSampleMode.equals("off")) {
