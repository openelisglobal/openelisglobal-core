 ...
 * 
 */
public class QaEventsEntryFromResultsEntryAction extends BaseAction {
	...
	protected ActionForward performAction(ActionMapping mapping,
		...
		QaEventRoutingSwitchSessionHandler.switchOn(QA_EVENTS_ENTRY_ROUTING_FROM_RESULTS_ENTRY, session);
		...
		if (!StringUtil.isNullorNill(accessionNumber)) {
			...
			try {
    			...
    			//bugzilla 2154
			    LogEvent.logError("QaEventsEntryFromResultsEntryAction","performAction()",lre.toString());
