 ...
 */
public class QaEventsEntryCancelToResultsEntryAction extends BaseAction {
	...
	protected ActionForward performAction(ActionMapping mapping,
		...
		QaEventRoutingSwitchSessionHandler.switchOff(QA_EVENTS_ENTRY_ROUTING_FROM_RESULTS_ENTRY, session);
