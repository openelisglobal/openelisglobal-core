 ...
 * 
 */
public class QaEventsEntryFromTestManagementAction extends BaseAction {
	...
	protected ActionForward performAction(ActionMapping mapping,
		...
		QaEventRoutingSwitchSessionHandler.switchOn(QA_EVENTS_ENTRY_ROUTING_FROM_TEST_MANAGEMENT, session);
		...
		if (!StringUtil.isNullorNill(accessionNumber)) {
			...
			try {
    			...
    			//bugzilla 2154
			    LogEvent.logError("QaEventsEntryFromTestManagementAction","performAction()",lre.toString());
