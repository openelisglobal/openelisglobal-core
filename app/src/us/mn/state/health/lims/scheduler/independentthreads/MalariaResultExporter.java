...
public class MalariaResultExporter extends Thread {
	...
	public MalariaResultExporter(long sleepInMin) {
	...
	private boolean shouldReportResults() {
		String reportResults = ConfigurationProperties.getInstance().getPropertyValueLowerCase(Property.malariaCaseReport);
	...
	class SuccessReportHandler implements ITransmissionResponseHandler {
		...
		private DocumentType getResultType() {
			return new DocumentTypeDAOImpl().getDocumentTypeByName("malariaCase");
		}
