    ...
    <tr>
     ...
     <td colspan="6" scope="col" bgcolor="#CCCC99">
      ...
      <tr>
        ...
        <!--bugzilla 2625-->
        <td>&nbsp;<app:text name="<%=formName%>" property="project.localAbbreviation" allowEdits="false" />
             <logic:notEmpty name="<%=formName%>" property="project.localAbbreviation">
                /
             </logic:notEmpty>
             <app:text name="<%=formName%>" property="project.projectName" allowEdits="false" /></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>&nbsp;<app:text name="<%=formName%>" property="collectionDateForDisplay" allowEdits="false"/></td>
