...
<div id="editDiv" >
    ...
    <h2><bean:message key="configuration.testUnit.create"/> </h2>

    <table>
        <tr>
            <th colspan="2" style="text-align: center"><bean:message key="testUnit.new"/></th>
        </tr>
        <tr>
...
<h3><bean:message key="testUnit.existing" /></h3>
<table width="80%">
    ...
    <h3><bean:message key="testUnit.existing.inactive" /></h3>
    <table width="80%">
        <%  testCount = 0;
            columnCount = 0;
