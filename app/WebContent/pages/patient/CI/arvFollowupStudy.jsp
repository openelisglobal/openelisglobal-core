...
function ArvFollowupProjectChecker() {
	...
	/**
	 * Check VL form all hidden and disabled fields are set in the right state.
	 **/	
	 ...
	 this.checkInterruptedARVTreatment = function () {
		...
		this.displayedByInterruptedARVTreatment = function () {
			...
			showElements( (field.selectedIndex == 1), "farv.arvTreatmentInitDateRow,farv.arvTreatmentTherapRow,farv.onGoingARVTreatmentINNsRow,farv.currentARVTreatmentINNRow0,farv.currentARVTreatmentINNRow1,farv.currentARVTreatmentINNRow2,farv.currentARVTreatmentINNRow3" );
		} 
		...
		this.displayedByVLBenefit = function () {
			...
			showElements( (field.selectedIndex == 1), "farv.priorVLLabRow,farv.priorVLValueRow,farv.priorVLDateRow" );
		}
...
<table style="width:100%">
	...
	<tr><td colspan="5"><hr/></td></tr><!-- __________________________________________________________________________________________________ -->
		...
		<td>
			<html:select name="<%=formName%>" 
				...
				styleId="farv.currentARVTreatment"  >
				<app:optionsCollection name="<%=formName%>" 
	...
	<tr id="farv.arvTreatmentInitDateRow" style="display:none"> 
		...
		<app:text name="<%=formName%>"
				...
				onkeyup="addDateSlashes(this, event);"
				onchange="farv.checkDate(this,false);"
				styleClass="text"
				styleId="farv.arvTreatmentInitDate" maxlength="10"/>
				<div id="farv.arvTreatmentInitDateMessage" class="blank"></div>
		</td>
	</tr>
	...
	<tr id="farv.arvTreatmentTherapRow" style="display:none">
		...
		<td>
			<html:select name="<%=formName%>" 
				...
				onchange="makeDirty();compareAllObservationHistoryFields(true);" 
				styleId="farv.arvTreatmentRegime" 
				styleClass="text" >
	...
	<logic:iterate id="ongoingARVTreatment" indexId="i" name="<%=formName%>" property="observations.currentARVTreatmentINNsList" >
		<tr style="display:none" id='<%= "farv.currentARVTreatmentINNRow" + i %>'>
			<td></td>
			<td class="bulletItem"><%= i+1 %>)</td>
			<td>
				<html:text name="<%=formName%>"
					...
					onchange="makeDirty();compareAllObservationHistoryFields(true);" 
					styleClass="text" styleId='<%= "farv.currentARVTreatmentINNs" + i %>' >
				</html:text>
				<div id='<%= "farv.currentARVTreatmentINNs" + i %>Message' class="blank"></div>
			</td>
		</tr>
	</logic:iterate>
    ...
    <tr > 
		...
		<td>
			...
			<div id="farv.vlReasonForRequestMessage" class="blank"></div>
		</td>
	</tr>
	...
	<tr id="farv.reasonOtherRow" style="display:none"> 
		...
		<td class="Subquestion">
			<bean:message key="sample.entry.project.farv.specify"/>
		</td>
		<td>
		<app:text name="<%=formName%>"
				...
				onchange="compareAllObservationHistoryFields(true);" 
				styleClass="text"
				styleId="farv.vlOtherReasonForRequest" maxlength="50"/>
				<div id="farv.vlOtherReasonForRequestMessage" class="blank"></div>
		</td>
	</tr>
	...
	<tr> 
		...
		<td>
			<app:text name="<%=formName%>" property="observations.initcd4Count"
				...
				maxlength="4"
				styleClass="text" 
				styleId="farv.initcd4Count" />
			<div id="farv.initcd4CountMessage" class="blank"></div>
		</td>
	</tr>
	<tr> 
		<td></td>
		...
		<td>
			<app:text name="<%=formName%>" property="observations.initcd4Percent"
				onchange="makeDirty();compareAllObservationHistoryFields(true);" 
				styleClass="text" 
				styleId="farv.initcd4Percent" />
			<div id="farv.initcd4PercentMessage" class="blank"></div>
		</td>
	</tr>	
	<tr> 
		<td></td>
		...
		<td>
			<app:text name="<%=formName%>"
				...
				onchange="farv.checkDate(this,false);"
				styleClass="text"
				styleId="farv.initcd4Date" maxlength="10"/>
				<div id="farv.initcd4DateMessage" class="blank"></div>
		</td>
	</tr>
	<tr><td colspan="5"><hr/></td></tr><!-- _________________________________________________ -->
	...
	<tr> 
		...
		<td>
			<app:text name="<%=formName%>" property="observations.demandcd4Count"
				...
				maxlength="4"
				styleClass="text" 
				styleId="farv.demandcd4Count" />
			<div id="farv.demandcd4CountMessage" class="blank"></div>
		</td>
	</tr>
	<tr> 
		<td></td>
		...
		<td>
			<app:text name="<%=formName%>" property="observations.demandcd4Percent"
				onchange="makeDirty();compareAllObservationHistoryFields(true);" 
				styleClass="text" 
				styleId="farv.demandcd4Percent" />
			<div id="farv.demandcd4PercentMessage" class="blank"></div>
		</td>
	</tr>	
	<tr> 
		<td></td>
		...
		<td>
			<app:text name="<%=formName%>"
				...
				onchange="farv.checkDate(this,false);"
				styleClass="text"
				styleId="farv.demandcd4Date" maxlength="10"/>
				<div id="farv.demandcd4DateMessage" class="blank"></div>
		</td>
	</tr>
	<tr><td colspan="5"><hr/></td></tr><!-- __________________________________________________________________________________________________ -->
...
<tr> 
		...
		<td>
			<html:select name="<%=formName%>" 
				...
				styleId="farv.vlBenefit"  >
				<app:optionsCollection name="<%=formName%>" 
				    property="dictionaryLists.YES_NO.list"
					label="localizedName" value="id" />
			</html:select>
			<div id="farv.vlBenefitMessage" class="blank"></div>
		</td>
	</tr>
	...
	<tr id="farv.priorVLLabRow" style="display:none"> 
		...
		<app:text name="<%=formName%>"
				...
				styleClass="text"
				styleId="farv.priorVLLab" maxlength="50"/>
				<div id="farv.priorVLLabMessage" class="blank"></div>
		</td>
	...
	<tr id="farv.priorVLValueRow" style="display:none"> 
		...
		<app:text name="<%=formName%>"
				...
				styleClass="text"
				onkeypress="farv.IsNumeric(this,event);"
				styleId="farv.priorVLValue" maxlength="10"/>
				<div id="farv.priorVLValueMessage" class="blank"></div>
		</td>
	...
	<tr id="farv.priorVLDateRow" style="display:none"> 
		...
		<app:text name="<%=formName%>"
				...
				onchange="farv.checkDate(this,false);"
				styleClass="text"
				styleId="farv.priorVLDate" maxlength="10"/>
				<div id="farv.priorVLDateMessage" class="blank"></div>
		</td>
	</tr>
	<tr>
        <td>&nbsp;</td>
