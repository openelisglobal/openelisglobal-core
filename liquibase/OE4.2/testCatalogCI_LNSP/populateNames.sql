...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Determine', (select reporting_description from clinlims.test where guid = '73b429df-6924-4bae-8194-4bb200216b44' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Determine', (select reporting_description from clinlims.test where guid = '9910e890-6b5e-4a07-961e-2416fb6b8c6a' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Determine', (select reporting_description from clinlims.test where guid = '2f831c64-89bb-438d-8049-f0c88e8fb7fa' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Bioline', (select reporting_description from clinlims.test where guid = '967630ae-4a03-4fec-b8dd-e4c59158d97a' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Bioline', (select reporting_description from clinlims.test where guid = 'f5ca0517-5fa1-4cb3-b039-52a3ac1ef3bf' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Bioline', (select reporting_description from clinlims.test where guid = '3c8a481a-1b91-4e00-ba93-93fc139741b3' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Stat PaK', (select reporting_description from clinlims.test where guid = '575f80f5-420f-4436-8062-5ca2c1a39ae7' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Stat PaK', (select reporting_description from clinlims.test where guid = '790b136b-e789-4f0c-a6ce-15cdcef4e228' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Stat PaK', (select reporting_description from clinlims.test where guid = 'a8390d02-a253-450f-b03d-5b81281a30e5' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'CD4 Absolute count (mm3)', (select reporting_description from clinlims.test where guid = '9c07b244-e94f-4e22-886c-7912a54d990b' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'CD4 percent  (%)', (select reporting_description from clinlims.test where guid = '98ade179-afd2-4aed-91cd-12ca2fe30063' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'GPT/ALAT', (select reporting_description from clinlims.test where guid = '8d2fd129-ac45-4254-a244-1d180b97fbab' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'GOT/ASAT', (select reporting_description from clinlims.test where guid = '09767094-02ee-4883-9c16-0ec4df27cfad' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Glucose', (select reporting_description from clinlims.test where guid = '48c97b18-0953-4790-8b25-0b608db640a4' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Glucose', (select reporting_description from clinlims.test where guid = '603dbd94-d252-4891-83cb-07ab56b7d281' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Creatinine', (select reporting_description from clinlims.test where guid = 'f71d96b0-e2ea-4833-a259-8faa9aa7ae20' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Amylase', (select reporting_description from clinlims.test where guid = 'ef5dd716-7f79-4b32-8eee-3f4ff5767039' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Albumin', (select reporting_description from clinlims.test where guid = '9fa2cca1-79e3-49e1-9f87-9737e9b952de' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Total cholesterol', (select reporting_description from clinlims.test where guid = '20051f21-94ad-44ff-ba0c-a6da6245bf01' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'HDL cholesterol', (select reporting_description from clinlims.test where guid = '55e4b726-86d5-4c18-a36a-9e6c8b0b1f0a' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Triglicerides', (select reporting_description from clinlims.test where guid = '9f078029-9b00-4856-b59e-e7604af29a92' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Viral load', (select reporting_description from clinlims.test where guid = '027dde83-61e2-49f0-b20b-f40bf7b7ee10' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Beta HCG', (select reporting_description from clinlims.test where guid = 'b101c41b-922f-4e37-ac01-017230fd9fe7' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'White Blood Cells Count (WBC)', (select reporting_description from clinlims.test where guid = 'd3b227d6-53ce-4402-bb0b-8f271e3b27e6' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Red Blood Cells Count (RBC)', (select reporting_description from clinlims.test where guid = 'fdae85ea-3034-43af-9e11-55d5032256b5' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Hemoglobin', (select reporting_description from clinlims.test where guid = '781848ae-ada5-465c-9a19-d941dd424962' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Hematocrit', (select reporting_description from clinlims.test where guid = 'dacf059a-bf70-48a6-849a-28d462087f6e' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Medium corpuscular volum', (select reporting_description from clinlims.test where guid = '29736377-dd22-42bb-b3ba-2d1e5db8549f' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'TMCH', (select reporting_description from clinlims.test where guid = '092a766e-6549-4838-a96f-7bfbc547b06d' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'CMCH', (select reporting_description from clinlims.test where guid = '42d607b3-8283-41ba-9d33-927e31a9f2a4' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Platelets', (select reporting_description from clinlims.test where guid = 'a5ac2b5d-d958-419e-ab48-69328adc74a3' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Neutrophiles (%)', (select reporting_description from clinlims.test where guid = '37f96e86-6036-4710-83f6-325f0b815d24' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Neutrophiles', (select reporting_description from clinlims.test where guid = '82172296-a86f-4d90-b2d8-cbd1fe089df7' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Eosinophiles (%)', (select reporting_description from clinlims.test where guid = '77d0d185-9e43-4f6a-bd11-3c34e4419a26' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Eosinophiles', (select reporting_description from clinlims.test where guid = '30d037e5-fa9e-4bb3-ae42-8c098e1536b4' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Basophiles (%)', (select reporting_description from clinlims.test where guid = '7864e487-94d4-4f2a-9a14-87fdf4814f26' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Basophiles', (select reporting_description from clinlims.test where guid = 'e21958b9-17b6-41c6-bfb9-e1017cad627b' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Lymphocytes (%)', (select reporting_description from clinlims.test where guid = '03074da7-5f1b-41ed-ba29-f4c22276f3cc' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Lymphocytes (Abs)', (select reporting_description from clinlims.test where guid = 'd5325b4c-6e38-4214-84cc-6eb3026f653a' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Monocytes (%)', (select reporting_description from clinlims.test where guid = '751a0897-d8a5-4c89-910c-12244193599f' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Monocytes (Abs)', (select reporting_description from clinlims.test where guid = 'd6ddad61-a22e-471f-af05-a0b3e367c776' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'HBsAg (Hepatitis B surface antigen)', (select reporting_description from clinlims.test where guid = '6e1bdbb1-ccc7-48ac-bc81-b268be0f4e6f' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Urine prenancy test', (select reporting_description from clinlims.test where guid = '21e89098-62c7-44c5-bd13-da81c99496eb' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Proteinuria dipstick', (select reporting_description from clinlims.test where guid = '43ea7a95-242c-4514-ae6e-662c68904181' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', (select reporting_description from clinlims.test where guid = '6a8a40ee-5452-4545-89a9-52c21a5d8ad9' ), (select reporting_description from clinlims.test where guid = '6a8a40ee-5452-4545-89a9-52c21a5d8ad9' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Genie II', (select reporting_description from clinlims.test where guid = '3b33e7eb-1572-46b0-95c4-5860540b57b7' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Genie II', (select reporting_description from clinlims.test where guid = 'e93f41ab-3763-4d70-a28e-890ef24fd391' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Genie II 10', (select reporting_description from clinlims.test where guid = 'b62af6bf-9106-4907-824f-4f69e96bdace' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Genie II 10', (select reporting_description from clinlims.test where guid = '50599045-6e84-4669-83ac-db6b658868b8' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Genie II 100', (select reporting_description from clinlims.test where guid = '732813b5-6745-4f9d-bf5f-bf69c6c9df56' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Genie II 100', (select reporting_description from clinlims.test where guid = '7ed7bb62-04b9-48c7-8b31-ed7ccf86f4f3' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Vironstika', (select reporting_description from clinlims.test where guid = '6e1b2678-1e98-4dd3-aa8d-16e5c6e456de' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Genie III', (select reporting_description from clinlims.test where guid = 'e8ace732-3607-40f1-9195-1c974e8086e4' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Genie III', (select reporting_description from clinlims.test where guid = '10c9e9ea-92d6-4769-9441-d79f6593e369' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Genie III', (select reporting_description from clinlims.test where guid = '3ad1c0f7-7e47-4db1-b0ed-6abadc776d6e' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Murex', (select reporting_description from clinlims.test where guid = '82b7f700-2c80-42c9-aeba-4e19c32b04ee' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Integral', (select reporting_description from clinlims.test where guid = '80cfa82f-43c5-44f3-8c0f-b920fe65db72' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Western blot 1', (select reporting_description from clinlims.test where guid = '18e77469-6e2f-4a1d-9e98-20110d401065' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'Western blot 2', (select reporting_description from clinlims.test where guid = 'aa0b9c9c-834a-4663-8ded-c67cd2b6fead' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'p24Ag', (select reporting_description from clinlims.test where guid = '08c6d514-d27d-44b2-9e76-d25a58b1df41' ), now());
...
INSERT INTO localization(  id, description, english, french, lastupdated)
	VALUES ( nextval('localization_seq'), 'test report name', 'DNA PCR', (select reporting_description from clinlims.test where guid = '27e4527f-1e31-4ddf-b2ba-39b1a11da0d5' ), now());
